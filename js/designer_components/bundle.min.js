var a=class{static postLoad(){}constructor(t,e,i){this.domNode=t,this.pyComponent=e,this.el=i}static init(t,e="anvil-extras-designer"){let i=()=>{this.loading=!0,$(()=>{this.setup(t,e),this.postLoad(),this.loaded=!0,this.loading=!1})};if(!this.loaded&&!this.loading){if(this.loading=!0,this.links.forEach(s=>{let n=document.createElement("link");n.href=s,n.rel="stylesheet",document.body.appendChild(n)}),this.css){let s=document.createElement("style");s.innerHTML=this.css,document.body.appendChild(s)}if(this.script){let s=document.createElement("script");s.src=this.script,document.body.appendChild(s),s.onload=i}else i()}else this.loading||i()}static setup(t,e){for(let i of document.querySelectorAll(t)){let s=i.parentElement;if(s.classList.contains(e))return;s.classList.add(e);let n=$(s).data("anvilPyComponent"),l=n._anvil.customPropVals,o=new this(s,n,i);l&&o.makeGetSets(l),o.update({...l||this.defaults})}}makeGetSets(t){let e={...t},i=this;for(let s in e)this.setProp(s,t[s]),Object.defineProperty(t,s,{get(){return e[s]},set(n){e[s]=n;try{i.setProp(s,n),i.update({...e},s,n)}catch{}return!0}})}update(t,e,i){}setProp(t,e){}updateSpacing({spacing_above:t,spacing_below:e}){let i=Array.prototype.filter.call(this.domNode.classList,s=>s.startsWith("anvil-spacing-"));this.domNode.classList.remove(...i),t&&this.domNode.classList.add("anvil-spacing-above-"+t),e&&this.domNode.classList.add("anvil-spacing-above-"+e)}updateRole({role:t}){let e=Array.prototype.filter.call(this.domNode.classList,i=>i.startsWith("anvil-role-"));this.domNode.classList.remove(...e),t&&this.domNode.classList.add("anvil-role-"+t)}updateVisible({visible:t}){this.domNode.classList.toggle("visible-false",!t)}getColor(t,e){return t&&t.startsWith("theme:")&&(t=window.anvilThemeColors[t.replace("theme:","")]||""),!t&&e?e===!0||e==="primary"?window.anvilThemeColors["Primary 500"]||"#2196F3":e:t}getColorRGB(t,e){if(t=this.getColor(t,e),t&&t.startsWith("#")){let i=parseInt(t.slice(1),16);return[i>>16&255,i>>8&255,i&255].join(",")}else if(t&&t.startsWith("rgb("))return t.slice(4,t.length-1);return t}clearElement(t){for(;t.firstElementChild;)t.removeChild(t.firstElementChild)}get[Symbol.toStringTag](){return"Designer Component"}};a.css="",a.links=[],a.script="",a.loaded=!1,a.loading=!1,a.defaults={},a.initializing=!1;var p=class extends a{static postLoad(){$.fn.selectpicker.Constructor.BootstrapVersion="3"}static init(){super.init(".select-picker")}constructor(t,e,i){super(t,e,i);this.picker=$(i),this.picker.selectpicker()}update(t,e){e&&!(e in this.constructor.defaults)||(this.picker.attr("title",t.placeholder||null),this.picker.selectpicker({title:t.placeholder}),this.picker.attr("disabled",t.enabled?null:""),this.updateSpacing(t),this.updateVisible(t),this.picker.selectpicker("refresh"),this.picker.selectpicker("render"))}};p.defaults={placeholder:"None Selected",enabled:!0,visible:!0,spacing_above:"small",spacing_below:"small"},p.links=["https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/css/bootstrap-select.min.css"],p.script="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/js/bootstrap-select.min.js";var u=class extends a{static init(){super.init(".quill-editor")}constructor(t,e,i){super(t,e,i);this.editor=i}update(t){this.editor.firstElementChild&&this.editor.removeChild(this.editor.firstElementChild),this.domNode.firstElementChild!==this.editor&&this.domNode.removeChild(this.domNode.firstElementChild);let e=new Quill(this.editor,{modules:{toolbar:t.toolbar||!1},readOnly:t.readonly,theme:t.theme,placeholder:t.placeholder});this.updateSpacing(t),this.updateVisible(t);let i=t.height;i=(""+i).match(/[a-zA-Z%]/g)?i:i+"px",this.editor.style.minHeight=i,this.editor.style.height=t.auto_expand?i:"auto",e.setText(t.content||"")}get[Symbol.toStringTag](){return"Quill"}};u.defaults={auto_expand:!0,content:"",height:150,placeholder:null,readonly:!1,theme:"snow",toolbar:!0,visible:!0},u.links=["//cdn.quilljs.com/1.3.6/quill.snow.css","//cdn.quilljs.com/1.3.6/quill.bubble.css"],u.script="//cdn.quilljs.com/1.3.6/quill.min.js";var h=class extends a{static init(){super.init(".anvil-slider","anvil-slider-container")}constructor(t,e,i){super(t,e,i);this.slider=i}parse(t,e=!1){if(typeof t!="string")return t;if(t=t.toLowerCase().trim(),!t)return e?[]:null;try{return JSON.parse((e||t.includes(","))&&t[0]!=="["?`[${t}]`:t)}catch{return e?[]:t}}getFormatter(t){let e=t.indexOf("{"),i=t.indexOf("}"),s=e===-1?"":t.slice(0,e),n=i===-1?"":t.slice(i+1),l=t[i-1]==="%"?"%":null,o=Sk.ffi.toPy(t),d=o.tp$getattr(Sk.ffi.toPy("format")),c=r=>{let m=Sk.ffi.toPy(r);return e===-1?Sk.builtin.format(m,o):d.tp$call([m])};try{c(1.1)}catch(r){throw new Error(r.toString())}return{to:r=>{try{return c(r)}catch{return r}},from:r=>{r.startsWith(s)&&(r=r.slice(s.length)),r.endsWith(n)&&(r=r.slice(0,r.length-n.length));let m=l==="%"&&r.endsWith("%");r=r.trim().replace(/[,_]/g,"");let f=parseFloat(r);return m&&(f=f/100),f}}}update(t){try{for(let e of["start","connect","margin","padding","limit","pips_values"])t[e]=this.parse(t[e],e==="pips_values");t.range={min:t.min,max:t.max},t.format=this.getFormatter(t.format||".2f"),t.pips&&(t.pips={format:t.format,mode:t.pips_mode,values:t.pips_values,density:t.pips_density,stepped:t.pips_stepped}),this.domNode.classList.toggle("has-pips",!!t.pips),this.slider.noUiSlider?.destroy(),this.slider.firstElementChild&&this.slider.removeChild(this.slider.firstElementChild),this.domNode.style.setProperty("--primary",this.getColor(t.color,!0)),this.updateSpacing(t),this.updateVisible(t),t.enabled?this.slider.removeAttribute("disabled"):this.slider.setAttribute("disabled",""),noUiSlider.create(this.slider,t)}catch(e){this.slider.noUiSlider?.destroy(),this.slider.firstElementChild&&this.slider.removeChild(this.slider.firstElementChild);let i=$(`<div class='invalid-component'>
...
.noUi-horizontal .noUi-handle{width:34px;height:34px;right:-17px;top:-10px;border-radius:50%}.noUi-handle::after,.noUi-handle::before{content:none}`;var y=class extends a{static init(){super.init(".anvil-extras-switch")}constructor(t,e,i){super(t,e,i);let s=e._anvil.components[0].component,n=s._anvil.domNode;n.classList.add("switch"),n.style.setProperty("--color",this.getColorRGB("#2196F3"));let l=n.querySelector("span");l.classList.add("lever"),l.removeAttribute("style");let o=n.querySelector("label"),d=document.createTextNode(""),c=document.createTextNode("");o.prepend(d),o.append(c),o.style.padding="7px 0",this.cb=s,this.cbNode=n,this.textNodePre=d,this.textNodePost=c}setProp(t,e){try{this.cb._anvil.setProp(t,Sk.ffi.toPy(e))}catch(i){t==="checked_color"?this.cbNode.style.setProperty("--color",this.getColorRGB(e,!0)):t==="text_pre"?this.textNodePre.textContent=e:this.textNodePost.textContent=e}}get[Symbol.toStringTag](){return"Switch"}};y.css=`
...
.tabs .indicator{position:absolute;bottom:0;height:3px;background-color:rgb(var(--color), 0.4);will-change:left, right}`;export{p as DesignerMultiSelectDropDown,u as DesignerQuill,h as DesignerSlider,y as DesignerSwitch,g as DesignerTabs};
