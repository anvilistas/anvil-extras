...
.noUi-horizontal .noUi-handle{width:34px;height:34px;right:-17px;top:-10px;border-radius:50%}.noUi-handle::after,.noUi-handle::before{content:none}`;var y=class extends r{static init(){super.init(".anvil-extras-switch")}constructor(t,e,i){super(t,e,i);let s=e._anvil.components[0].component,n=s._anvil.domNode;n.classList.add("switch"),n.style.setProperty("--color",this.getColorRGB("#2196F3"));let l=n.querySelector("span");l.classList.add("lever"),l.removeAttribute("style");let c=n.querySelector("label"),a=document.createTextNode(""),d=document.createTextNode("");c.prepend(a),c.append(d),c.style.padding="7px 0",this.cb=s,this.cbNode=n,this.textNodePre=a,this.textNodePost=d}setProp(t,e,i){try{this.cb._anvil.setProp(t,Sk.ffi.toPy(e))}catch(s){t==="checked_color"?this.cbNode.style.setProperty("--color",this.getColorRGB(e,!0)):t==="text_pre"?this.textNodePre.textContent=e:this.textNodePost.textContent=e}}get[Symbol.toStringTag](){return"Switch"}};y.css=`
