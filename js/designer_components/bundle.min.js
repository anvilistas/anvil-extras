var r=class{constructor(e,t,i){this.domNode=e;this.pyComponent=t;this.el=i;this.domNode=e,this.pyComponent=t,this.el=i}static postLoad(){}static init(e,t="anvil-extras-designer"){let i=()=>{this.loading=!0,$(()=>{this.setup(e,t),this.postLoad(),this.loaded=!0,this.loading=!1})};if(!this.loaded&&!this.loading){if(this.loading=!0,this.links.forEach(s=>{let n=document.createElement("link");n.href=s,n.rel="stylesheet",document.body.appendChild(n)}),this.css){let s=document.createElement("style");s.innerHTML=this.css,document.body.appendChild(s)}if(this.scripts.length){let s=this.scripts.map(n=>new Promise((l,c)=>{let a=document.createElement("script");a.src=n,document.body.appendChild(a),a.onload=l,a.onerror=c}));Promise.all(s).then(i)}else i()}else this.loading||i()}static setup(e,t){for(let i of document.querySelectorAll(e)){let s=i.parentElement;if(s.classList.contains(t))return;s.classList.add(t);let n=$(s).data("anvilPyComponent"),l;try{l=n._anvil.customPropVals}catch(a){console.error(a);return}let c=new this(s,n,i);if(l)c.makeGetSets(l);else if(this.defaults){c.update({...this.defaults});for(let[a,d]of Object.entries(this.defaults))c.setProp(a,d,this.defaults)}}}makeGetSets(e){let t={...e},i=this;this.update({...t});for(let s in t)this.setProp(s,e[s],t),Object.defineProperty(e,s,{get(){return t[s]},set(n){t[s]=n;try{i.setProp(s,n,t),i.update({...t},s,n)}catch{}return!0}})}update(e,t,i){}setProp(e,t,i){}updateSpacing({spacing_above:e,spacing_below:t}){let i=Array.prototype.filter.call(this.domNode.classList,s=>s.startsWith("anvil-spacing-"));this.domNode.classList.remove(...i),e&&this.domNode.classList.add("anvil-spacing-above-"+e),t&&this.domNode.classList.add("anvil-spacing-above-"+t)}updateRole({role:e}){let t=Array.prototype.filter.call(this.domNode.classList,i=>i.startsWith("anvil-role-"));this.domNode.classList.remove(...t),e&&this.domNode.classList.add("anvil-role-"+e)}updateVisible({visible:e}){this.domNode.classList.toggle("visible-false",!e)}getColor(e,t){return e&&e.startsWith("theme:")&&(e=window.anvilThemeColors[e.replace("theme:","")]||""),!e&&t?t===!0||t==="primary"?window.anvilThemeColors["Primary 500"]||"#2196F3":t:e}getColorRGB(e,t){if(e=this.getColor(e,t),e&&e.startsWith("#")){let i=parseInt(e.slice(1),16);return[i>>16&255,i>>8&255,i&255].join(",")}else if(e&&e.startsWith("rgb("))return e.slice(4,e.length-1);return e}clearElement(e){for(;e.firstElementChild;)e.removeChild(e.firstElementChild)}get[Symbol.toStringTag](){return"Designer Component"}};r.css="",r.links=[],r.script=[],r.loaded=!1,r.loading=!1,r.defaults=null,r.initializing=!1;var b=class extends r{static postLoad(){$.fn.selectpicker.Constructor.BootstrapVersion="3"}static init(){super.init(".select-picker")}constructor(e,t,i){super(e,t,i);this.picker=$(i),this.picker.selectpicker()}update(e,t){t&&!(t in this.constructor.defaults)||(this.picker.attr("title",e.placeholder||null),this.picker.selectpicker({title:e.placeholder}),this.picker.attr("disabled",e.enabled?null:""),this.updateSpacing(e),this.updateVisible(e),this.picker.selectpicker("refresh"),this.picker.selectpicker("render"))}get[Symbol.toStringTag](){return"MultiSelectDropDown"}};b.defaults={placeholder:"None Selected",enabled:!0,visible:!0,spacing_above:"small",spacing_below:"small"},b.links=["https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/css/bootstrap-select.min.css"],b.scripts=["https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/js/bootstrap-select.min.js"];var u=class extends r{static init(){super.init(".quill-editor")}constructor(e,t,i){super(e,t,i);this.editor=i}update(e){this.editor.firstElementChild&&this.editor.removeChild(this.editor.firstElementChild),this.domNode.firstElementChild!==this.editor&&this.domNode.removeChild(this.domNode.firstElementChild);let t=new Quill(this.editor,{modules:{toolbar:e.toolbar||!1},readOnly:e.readonly,theme:e.theme,placeholder:e.placeholder});this.updateSpacing(e),this.updateVisible(e);let i=e.height;i=(""+i).match(/[a-zA-Z%]/g)?i:i+"px",this.editor.style.minHeight=i,this.editor.style.height=e.auto_expand?i:"auto",t.setText(e.content||"")}get[Symbol.toStringTag](){return"Quill"}};u.defaults={auto_expand:!0,content:"",height:150,placeholder:null,readonly:!1,theme:"snow",toolbar:!0,visible:!0},u.links=["//cdn.quilljs.com/1.3.6/quill.snow.css","//cdn.quilljs.com/1.3.6/quill.bubble.css"],u.script=["//cdn.quilljs.com/1.3.6/quill.min.js"];var p=class extends r{static init(){super.init(".anvil-slider","anvil-slider-container")}constructor(e,t,i){super(e,t,i);this.slider=i}parse(e,t=!1){if(typeof e!="string")return e;if(e=e.toLowerCase().trim(),!e)return t?[]:null;try{return JSON.parse((t||e.includes(","))&&e[0]!=="["?`[${e}]`:e)}catch{return t?[]:e}}getFormatter(e){let t=e.indexOf("{"),i=e.indexOf("}"),s=t===-1?"":e.slice(0,t),n=i===-1?"":e.slice(i+1),l=e[i-1]==="%"?"%":null,c=Sk.ffi.toPy(e),a=c.tp$getattr(Sk.ffi.toPy("format")),d=o=>{let m=Sk.ffi.toPy(o);return t===-1?Sk.builtin.format(m,c):a.tp$call([m])};try{d(1.1)}catch(o){throw new Error(o.toString())}return{to:o=>{try{return d(o)}catch{return o}},from:o=>{o.startsWith(s)&&(o=o.slice(s.length)),o.endsWith(n)&&(o=o.slice(0,o.length-n.length));let m=l==="%"&&o.endsWith("%");o=o.trim().replace(/[,_]/g,"");let x=parseFloat(o);return m&&(x=x/100),x}}}update(e){try{for(let t of["start","connect","margin","padding","limit","pips_values"])e[t]=this.parse(e[t],t==="pips_values");e.range={min:e.min,max:e.max},e.format=this.getFormatter(e.format||".2f"),e.pips&&(e.pips={format:e.format,mode:e.pips_mode,values:e.pips_values,density:e.pips_density,stepped:e.pips_stepped}),this.domNode.classList.toggle("has-pips",!!e.pips),this.slider.noUiSlider?.destroy(),this.slider.firstElementChild&&this.slider.removeChild(this.slider.firstElementChild),this.domNode.style.setProperty("--primary",this.getColor(e.color,!0)),this.updateSpacing(e),this.updateVisible(e),e.enabled?this.slider.removeAttribute("disabled"):this.slider.setAttribute("disabled",""),noUiSlider.create(this.slider,e)}catch(t){this.slider.noUiSlider?.destroy(),this.slider.firstElementChild&&this.slider.removeChild(this.slider.firstElementChild);let i=$(`<div class='invalid-component'>
...
.noUi-horizontal .noUi-handle{width:34px;height:34px;right:-17px;top:-10px;border-radius:50%}.noUi-handle::after,.noUi-handle::before{content:none}`;var y=class extends r{static init(){super.init(".anvil-extras-switch")}constructor(e,t,i){super(e,t,i);let s=t._anvil.components[0].component,n=s._anvil.domNode;n.classList.add("switch"),n.style.setProperty("--color",this.getColorRGB("#2196F3"));let l=n.querySelector("span");l.classList.add("lever"),l.removeAttribute("style");let c=n.querySelector("label"),a=document.createTextNode(""),d=document.createTextNode("");c.prepend(a),c.append(d),c.style.padding="7px 0",this.cb=s,this.cbNode=n,this.textNodePre=a,this.textNodePost=d}setProp(e,t,i){try{this.cb._anvil.setProp(e,Sk.ffi.toPy(t))}catch(s){e==="checked_color"?this.cbNode.style.setProperty("--color",this.getColorRGB(t,!0)):e==="text_pre"?this.textNodePre.textContent=t:this.textNodePost.textContent=t}}get[Symbol.toStringTag](){return"Switch"}};y.css=`
